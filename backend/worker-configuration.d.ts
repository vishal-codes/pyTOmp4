/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ab5d945da0242500c403e35d79f43a1e)
// Runtime types generated with workerd@1.20250906.0 2025-09-11 
declare namespace Cloudflare {
	interface Env {
		AI_MODEL_DETECT: "@cf/qwen/qwen2.5-coder-32b-instruct";
		AI_MODEL_EVENTS: "@cf/qwen/qwen2.5-coder-32b-instruct";
		AI_MODEL_NARRATION: "@cf/meta/llama-3.1-8b-instruct";
		AI_MODEL_TTS: "@cf/myshell-ai/melotts";
		STREAM_API_TOKEN: string;
		STREAM_ACCOUNT_ID: string;
		pytomp4_r2: R2Bucket;
		pyTOmp4_d1: D1Database;
		prep_queue: Queue;
		py_to_mp4_render: Queue;
		AI: Ai;
	}
}
